                ...
                <div>
                    <h2 className="title">What's Hot!</h2>
                     <div className="flex justify-between mb-2">
                         ...
                         <h6 className="flex items-center cursor-pointer"><span className="text-neutral text-sm pr-2">View All</span><svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeWinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7"></path></svg></h6>
                     </div>
