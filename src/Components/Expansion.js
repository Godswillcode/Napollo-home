    ...
    <div className="myContainer mt-44">
      <div className="grid grid-cols-1 md:grid-cols-2">
        ...
        <div>
          ...
          <div className="mt-10">
              <ChildComp number="01" image={ex1} title1="Lights Out" title2="ColdPlay" icon="#3a3a3a"/>
           
              <ChildComp number="02" image={ex2} title2="Green Tuska" icon="#f78127"/>
              
              <ChildComp number="03" image={ex3}  title2="Bruno Mars" icon="#3a3a3a"/>
              <ChildComp number="04" image={ex4}  title2="Cardi" icon="#3a3a3a"/>
          </div>
        </div>
      </div>
    </div>
...
const ChildComp = ({number, image, title1, title2, icon}) => {
    return(
        <div className="flex items-center justify-self-stretch mt-5">
            <h4 className="text-white pr-3 font-bold">{number}</h4>
             ...
             <div>
                  ...
                  <span className="text-gray-600 font-medium text-sm">{title2}</span>
             </div>
