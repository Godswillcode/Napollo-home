...
const Listen = () => {
  return (
    <div className="bg-primary py-14 px-5">
      <div className="myContainer grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          ...
          <button className="rounded-2xl px-5 mt-4 py-1 text-primary text-sm" style={{background: "rgba(0,0,0,255)"}}>Start listening</button>
        </div>
      </div>
    </div>
  );
